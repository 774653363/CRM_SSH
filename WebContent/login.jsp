...
$(function(){
	$("#btn").click(function(){
		var url = "${pageContext.request.contextPath}/loginUser";
		$("#form1").attr("action",url);
		$("#form1").submit();
	});
	$("#btn2").click(function(){
		var url = "${pageContext.request.contextPath}/registUIUser";
		$("#form1").attr("action",url);
		$("#form1").submit();
	});
});
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=2 border=0>
              ...
              <TR>
                ...
                <TD><INPUT id=btn2 
                  style="BORDER-TOP-WIDTH: 0px; BORDER-LEFT-WIDTH: 0px; BORDER-BOTTOM-WIDTH: 0px; BORDER-RIGHT-WIDTH: 0px" 
                  type=image src="images/regist_button.gif" name=btn2> 
              </TD></TR>
